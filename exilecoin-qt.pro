...
#LIBS += -lboost_system-mgw48-mt-1_55 -lboost_filesystem-mgw48-mt-1_55 -lboost_program_options-mgw48-mt-1_55 -lboost_thread-mgw48-mt-1_55
DEPSDIR=C:/deps
...
OPENSSL_INCLUDE_PATH=$$DEPSDIR/openssl-1.0.1f/include
OPENSSL_LIB_PATH=$$DEPSDIR/openssl-1.0.1f
MINIUPNPC_LIB_PATH=$$DEPSDIR/miniupnpc
MINIUPNPC_INCLUDE_PATH=$$DEPSDIR
QRENCODE_INCLUDE_PATH=C:/deps/qrencode-3.4.3
QRENCODE_LIB_PATH=$$DEPSDIRqrencode-3.4.3/.libs
OBJECTS_DIR = build
...
!windows|contains(USE_BUILD_INFO, 1) {
    ...
    genbuild.commands = cd $$PWD; sh share/genbuild.sh $$OUT_PWD/build/build.h
...
isEmpty(BOOST_LIB_SUFFIX) {
    ...
    windows:BOOST_LIB_SUFFIX = $$BOOST_LIB_SUFFIX
}
