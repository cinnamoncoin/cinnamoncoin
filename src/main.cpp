...
unsigned int nStakeTargetSpacing = 300;			// 5-minute block spacing

int64 nChainStartTime = 1379687329;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight < 300){ nSubsidy = 1 * COIN;} //300 blocks to allow target levels to stabilize
	nSubsidy >>= (nHeight / 210240); //Block rewards halve every 2 years
...
static const int64 nTargetTimespan = 30 * 120;  
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xb250bb4717931630f55e6ca1a2d8767b9df6fc108d7bd595800dbdb2c8558da1"));
...
unsigned char pchMessageStart[4] = { 0xdb, 0xc0, 0xdb, 0xf2 };
